...
export const AGENCY_MODULES: ModuleDef[] = [
  ...
  { key: "scheduling",     label: "Scheduling",     path: "/scheduling", icon: CalendarRange, portal: "agency", permission: "scheduling", status: "live", group: "operations" },
  ...
  { key: "timecards",      label: "Timecards",      path: "/timecards", icon: Clock, portal: "agency", permission: "timecards", status: "live", group: "operations" },
  ...
  { key: "ai_center",      label: "AI Center",      path: "/ai-center", icon: Sparkles, portal: "agency", permission: "ai_center", status: "live", group: "insights" },
  { key: "reports",        label: "Reports",        path: "/reports", icon: BarChart3, portal: "agency", permission: "reports", status: "live", group: "insights" },
  { key: "network",        label: "Network",        path: "/network", icon: Network, portal: "agency", permission: "network", status: "live", group: "insights" },
