...
export const EXTRA_DESTINATIONS: CommandDef[] = [
  ...
  { id: "go.memory", label: "WOIC Working Memory — Show Active Memory Sessions", group: "Go to", icon: Boxes, kind: "navigate", to: "/memory/sessions", keywords: ["working memory", "session", "cognitive memory", "woic"] },
  { id: "go.memory.overview", label: "Show Memory Health", group: "Go to", icon: Boxes, kind: "navigate", to: "/memory/health", keywords: ["memory health", "capacity", "pressure", "conflict"] },
  { id: "go.memory.pressure", label: "Show High Memory Pressure", group: "Go to", icon: Boxes, kind: "navigate", to: "/memory/budgets", keywords: ["memory pressure", "budget", "capacity", "threshold"] },
  { id: "go.memory.questions", label: "Show Open Cognitive Questions", group: "Go to", icon: Boxes, kind: "navigate", to: "/memory/questions", keywords: ["open question", "unresolved", "blocking"] },
  { id: "go.memory.blocked", label: "Show Blocked Cognitive Sessions", group: "Go to", icon: Boxes, kind: "navigate", to: "/memory/goals", keywords: ["blocked", "waiting", "goal", "subgoal"] },
  { id: "go.memory.checkpoints", label: "Open Checkpoint Center", group: "Go to", icon: Boxes, kind: "navigate", to: "/memory/checkpoints", keywords: ["checkpoint", "restore", "state version"] },
  { id: "go.memory.expired", label: "Show Expired Working Memory", group: "Go to", icon: Boxes, kind: "navigate", to: "/memory/lifecycle", keywords: ["expired", "evicted", "promoted", "lifecycle"] },
  { id: "go.reasoning", label: "WOIC Reasoning & Evidence — Show Conclusions", group: "Go to", icon: Boxes, kind: "navigate", to: "/reasoning/conclusions", keywords: ["reasoning", "conclusion", "evidence", "woic"] },
  { id: "go.reasoning.low_confidence", label: "Show Low-Confidence Conclusions", group: "Go to", icon: Boxes, kind: "navigate", to: "/reasoning/conclusions", keywords: ["low confidence", "uncertain", "weak conclusion"] },
  { id: "go.reasoning.contested", label: "Show Contested Conclusions", group: "Go to", icon: Boxes, kind: "navigate", to: "/reasoning/contradictions", keywords: ["contested", "contradiction", "conflict", "disputed"] },
  { id: "go.reasoning.disagreements", label: "Show Model Disagreements", group: "Go to", icon: Boxes, kind: "navigate", to: "/reasoning/disagreements", keywords: ["model disagreement", "faculty", "divergence"] },
  { id: "go.reasoning.insufficient", label: "Show Insufficient Evidence Results", group: "Go to", icon: Boxes, kind: "navigate", to: "/reasoning/active", keywords: ["insufficient evidence", "cannot conclude", "unknown"] },
  { id: "go.reasoning.critique", label: "Show Critical Review Results", group: "Go to", icon: Boxes, kind: "navigate", to: "/reasoning/critical-review", keywords: ["critical review", "critique", "self-review", "revision"] },
  { id: "go.reasoning.evidence", label: "Explain Evidence Behind a Conclusion", group: "Go to", icon: Boxes, kind: "navigate", to: "/reasoning/evidence", keywords: ["evidence", "provenance", "source", "explain"] },
  { id: "go.reasoning.causality", label: "Show Causal Claims", group: "Go to", icon: Boxes, kind: "navigate", to: "/reasoning/causality", keywords: ["causal", "causality", "correlation", "cause"] },
